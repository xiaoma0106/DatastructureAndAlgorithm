        ...
        $(function () {
            ...
            $(".updateCount").change(function () {
                ...
                if (confirm("确定要将《" + name + "》商品数量改为" + count + "吗?")) {
                    location.href="http://localhost:8080/BookStore/cartServlet?action=updateCount&id="+itemId+"&count="+count;
                } else {
        ...
        <c:if test="${not empty sessionScope.cart.items}">
            <c:forEach items="${sessionScope.cart.items}" var="entry">
                <tr>
                    ...
                    <td><input type="text" style="width: 80px" bookId="${entry.value.id}"
                               class="updateCount" value="${entry.value.count}"></td>
